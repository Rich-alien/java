...
public class TriangleGenerator {
    ...
    public TriangleGenerator(Integer n) {
    ...
    public boolean equals(Object o) {
        if(o instanceof TriangleGenerator) {
            TriangleGenerator tg = (TriangleGenerator)o;
    ...
    public static void test() {
        TriangleGenerator o1 = new TriangleGenerator(2);
        TriangleGenerator o2 = new TriangleGenerator(2);
        TriangleGenerator o3 = new TriangleGenerator(3);
    ...
    public static void main(String[] args) {
        Integer N = 10;
        TriangleGenerator tg = new TriangleGenerator(N);
